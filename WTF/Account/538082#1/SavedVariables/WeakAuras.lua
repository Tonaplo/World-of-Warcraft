...
WeakAurasSaved = {
	["dynamicIconCache"] = {
		["Fragile Echo"] = {
			[215267] = "INTERFACE\\ICONS\\spell_warlock_demonsoul",
		},
		["Dream Simulacrum"] = {
		...
		["Al'maiesh, the Cord of Hope"] = {
			[211440] = "Interface\\Icons\\Spell_Holy_PersuitofJustice",
			[211442] = "Interface\\Icons\\Spell_Holy_DivineProvidence",
		...
		["Water Shield"] = {
			[228981] = "Interface\\Icons\\ability_shawaterelemental_swirl",
		},
		["Immolate"] = {
			[216145] = "Interface\\Icons\\Spell_Fire_Immolation",
			[79937] = "Interface\\Icons\\Spell_Fire_Immolation",
			[157736] = 135817,
		},
		["Ice Barrier"] = {
		...
		["Fixate"] = {
			[143292] = "Interface\\Icons\\ability_fixated_state_purple",
			[198477] = 841383,
			[238674] = 841382,
		...
		["Norgannon's Foresight"] = {
			[236430] = "Interface\\Icons\\Spell_Arcane_FocusedPower",
		},
		["Scorned Touch"] = {
		...
		["Spanning Singularity"] = {
			[232974] = "Interface\\Icons\\Spell_Arcane_Blast",
		},
		["Fel Chakram"] = {
		...
		["Draenic Intellect Flask"] = {
			[156070] = "Interface\\Icons\\trade_alchemy_dpotion_c25",
		},
	...
	["frame"] = {
		["xOffset"] = -50.6563720703125,
		["yOffset"] = -207.076354980469,
	...
	["displays"] = {
		...
		["Death Knight Empower Rune Weapon"] = {
			...
			["inverse"] = true,
			["anchorFrameType"] = "SCREEN",
			["id"] = "Death Knight Empower Rune Weapon",
			["icon"] = true,
			["cooldown"] = true,
			["textColor"] = {
				0, -- [1]
		...
		["Brawlers Guild"] = {
			...
			["xOffset"] = 0.7672119140625,
			["disjunctive"] = "all",
			["border"] = "None",
			["yOffset"] = 273.228759765625,
			["anchorPoint"] = "CENTER",
			["selfPoint"] = "TOP",
			["sort"] = "none",
			["activeTriggerMode"] = -10,
		...
		["Priest PoM"] = {
			["parent"] = "UseNows",
			["untrigger"] = {
				["custom"] = "function(event, arg1, arg2, ...)\n    \n    local start, duration, enable = GetSpellCooldown(33076)\n    \n    if start and duration then -- the spell is on cooldown\n        local getTime = GetTime()\n        \n        -- start + duration gives us the value of GetTime() at the point when the cd will end\n        -- the time when the cd ends (a time in the future) minus the current time gives us the remaining duration on the cooldown\n        local remainingCD = start + duration - getTime\n        \n        -- if we're on cooldown and the total cooldown is greater than 2 seconds\n        -- this filters out global cooldown spells or spells whose cds are otherwise irrelevant\n        \n        if remainingCD > 0  and duration > 2 then\n            return true\n        end\n    end\n    return false\nend",
			},
			["anchorPoint"] = "CENTER",
			["activeTriggerMode"] = -10,
			["customTextUpdate"] = "update",
		...
		["Paladin Icons"] = {
			["grow"] = "HORIZONTAL",
			["controlledChildren"] = {
				"Paladin Holy Shock", -- [1]
				"Paladin Light of Dawn", -- [2]
				"Paladin Light's Hamnmer", -- [3]
				"Paladin Tyr's Deliverance", -- [4]
			},
			["disjunctive"] = "all",
			["yOffset"] = -250,
			["anchorPoint"] = "CENTER",
		...
		["Priest Serenity"] = {
			["disjunctive"] = "all",
			["untrigger"] = {
				["custom"] = "function(event, arg1, arg2, ...)\n    \n    local start, duration, enable = GetSpellCooldown(2050)\n    \n    if start and duration then -- the spell is on cooldown\n        local getTime = GetTime()\n        \n        -- start + duration gives us the value of GetTime() at the point when the cd will end\n        -- the time when the cd ends (a time in the future) minus the current time gives us the remaining duration on the cooldown\n        local remainingCD = start + duration - getTime\n        \n        -- if we're on cooldown and the total cooldown is greater than 2 seconds\n        -- this filters out global cooldown spells or spells whose cds are otherwise irrelevant\n        \n        if remainingCD > 0  and duration > 2 then\n            return true\n        end\n    end\n    return false\nend",
			},
			["anchorPoint"] = "CENTER",
			["activeTriggerMode"] = -10,
			["customTextUpdate"] = "update",
		...
		["Paladin Holy Shock"] = {
			...
			["auto"] = true,
			["numTriggers"] = 1,
			["id"] = "Paladin Holy Shock",
			["anchorFrameType"] = "SCREEN",
			["frameStrata"] = 1,
			["width"] = 40,
			["parent"] = "Paladin Icons",
			["disjunctive"] = "any",
			["inverse"] = true,
			["untrigger"] = {
				["showOn"] = "showAlways",
		...
		["Track FR 2"] = {
			...
			["trigger"] = {
				...
				["event"] = "Combat Log",
				["subeventSuffix"] = "_CAST_START",
				["customDuration"] = "function()\n    local now = time()\n    -- Second second\n    local start_track = now-1\n    local end_track = now-2 \n    local damage_value = 0\n    for key, value in pairs(WA_TABLE) do\n        -- If the damage occured within the second,\n        -- assign it to the damage value\n        if key > end_track and key < start_track then\n            damage_value = damage_value + value or 0\n        end\n    end\n    -- For timewalking/personal preference\n    local max_fr = UnitHealthMax(\"player\")/2\n    \n    return damage_value or 0,max_fr,true    \n    \nend\n\n\n\n\n\n\n\n\n\n\n",
				["events"] = "UNIT_HEALTH",
				["custom"] = "function()\n    return true\nend\n\n\n\n\n\n\n\n",
				["spellIds"] = {
				},
			...
			["auto"] = true,
			["sparkTexture"] = "Interface\\CastingBar\\UI-CastingBar-Spark",
			["parent"] = "FR Lite percentage with tracking",
		},
		["Mana Bar"] = {
			["textFlags"] = "None",
			["stacksSize"] = 12,
			...
			["borderBackdrop"] = "Blizzard Tooltip",
			["parent"] = "Elemental Maelstrom Bar",
			["customText"] = "function ()\n    local curr = UnitPower(\"player\", SPELL_POWER_MANA)\n    local max = UnitPowerMax(\"player\", SPELL_POWER_MANA)\n    \n    local pct = 100 * curr / max\n    pct = pct - ( pct % 1 )\n    \n    return tostring(pct) .. \"%%\"\nend\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n",
			["barInFront"] = true,
			["activeTriggerMode"] = 0,
			["sparkRotationMode"] = "AUTO",
			["textSize"] = 12,
		...
		["Death Knight Pillar of Frost"] = {
			...
			["desaturate"] = false,
			["icon"] = true,
			["id"] = "Death Knight Pillar of Frost",
			["stacksContainment"] = "INSIDE",
			["zoom"] = 0,
			["auto"] = true,
			["anchorFrameType"] = "SCREEN",
		...
		["Priest Cake"] = {
			["parent"] = "UseNows",
			["untrigger"] = {
				["custom"] = "function(event, arg1, arg2, ...)\n    \n    local start, duration, enable = GetItemCooldown(140793)\n    \n    if start and duration then -- the spell is on cooldown\n        local getTime = GetTime()\n        \n        -- start + duration gives us the value of GetTime() at the point when the cd will end\n        -- the time when the cd ends (a time in the future) minus the current time gives us the remaining duration on the cooldown\n        local remainingCD = start + duration - getTime\n        \n        -- if we're on cooldown and the total cooldown is greater than 2 seconds\n        -- this filters out global cooldown spells or spells whose cds are otherwise irrelevant\n        \n        if remainingCD > 0  and duration > 2 then\n            return true\n        end\n    end\n    return false\nend",
			},
			["anchorPoint"] = "CENTER",
			["activeTriggerMode"] = -10,
			["customTextUpdate"] = "update",
		...
		["Death Knight Gorefiends Grasp"] = {
			...
			["trigger"] = {
				...
				["realSpellName"] = "Gorefiend's Grasp",
				["use_spellName"] = true,
				["spellName"] = 108199,
				["use_unit"] = true,
				["showOn"] = "showAlways",
			...
			["id"] = "Death Knight Gorefiends Grasp",
			["stacksContainment"] = "INSIDE",
			["zoom"] = 0,
			["auto"] = true,
			["width"] = 40,
		...
		["Track FR 3"] = {
			...
			["trigger"] = {
				...
				["event"] = "Combat Log",
				["subeventSuffix"] = "_CAST_START",
				["customDuration"] = "function()\n    local now = time()\n    -- Third second\n    local start_track = now-2\n    local end_track = now-3 \n    local damage_value = 0\n    for key, value in pairs(WA_TABLE) do\n        -- If the damage occured within the second,\n        -- assign it to the damage value\n        if key > end_track and key < start_track then\n            damage_value = damage_value + value or 0\n        end\n    end\n    -- For timewalking/personal preference\n    local max_fr = UnitHealthMax(\"player\")/2\n    \n    return damage_value or 0,max_fr,true    \n    \nend\n\n\n\n\n\n\n\n\n\n\n",
				["custom"] = "function()\n    return true\nend\n\n\n\n\n\n\n\n",
				["events"] = "UNIT_HEALTH",
				["spellIds"] = {
				},
		...
		["Death Knight Dancing Rune Weapon"] = {
			...
			["id"] = "Death Knight Dancing Rune Weapon",
			["stacksContainment"] = "INSIDE",
			["zoom"] = 0,
			["auto"] = true,
			["width"] = 40,
		...
		["Shaman Hero"] = {
			...
			["fontSize"] = 15,
			["displayStacks"] = "%s",
			["customTriggerLogic"] = "function(trigger)\n    if(trigger[1]) then\n        WeakAuras.regions[aura_env.id].region.icon:SetTexture(\"Interface\\\\Icons\\\\spell_nature_sleep\")\n        WeakAuras.regions[aura_env.id].region.icon:SetDesaturated(true);\n        return true;\n    end\n    start, duration, enable = GetSpellCooldown(\"Heroism\");\n    --if(not start) then\n        --WeakAuras.regions[aura_env.id].region.icon:SetTexture(\"Interface\\\\Icons\\\\ability_shaman_heroism\")\n        WeakAuras.regions[aura_env.id].region.icon:SetDesaturated(false);\n        return true;\n   -- end\n    --return false;\nend",
			["regionType"] = "icon",
			["icon"] = true,
			["stickyDuration"] = false,
			["stacksPoint"] = "CENTER",
		...
		["Insanity Bar"] = {
			...
			["controlledChildren"] = {
				...
				"Insanity Bar - LotV Marker 1", -- [11]
				"Insanity Bar - LotV Marker 2", -- [12]
			},
			["borderBackdrop"] = "Blizzard Tooltip",
			["xOffset"] = 0,
			["border"] = false,
		...
		["Track FR 1"] = {
			...
			["trigger"] = {
				...
				["event"] = "Combat Log",
				["subeventSuffix"] = "_CAST_START",
				["customDuration"] = "function()\n    local now = time()\n    -- First second\n    local start_track = now\n    local end_track = now-1 \n    local damage_value = 0\n    for key, value in pairs(WA_TABLE) do\n        -- If the damage occured within the second,\n        -- assign it to the damage value\n        if key > end_track then\n            damage_value = damage_value + value or 0\n        end\n    end\n    -- For timewalking/personal preference\n    local max_fr = UnitHealthMax(\"player\")/2\n    \n    return damage_value or 0,max_fr,true\nend\n\n\n\n\n\n\n\n\n\n\n",
				["custom"] = "function()\n    return true\nend\n\n\n\n\n\n\n\n",
				["events"] = "UNIT_HEALTH",
				["spellIds"] = {
				},
		...
		["Death Knight Vampiric Blood"] = {
			...
			["desaturate"] = false,
			["icon"] = true,
			["id"] = "Death Knight Vampiric Blood",
			["stacksContainment"] = "INSIDE",
			["zoom"] = 0,
			["auto"] = true,
			["anchorFrameType"] = "SCREEN",
		...
		["Priest Penance"] = {
			["parent"] = "UseNows",
			["untrigger"] = {
				["custom"] = "function(event, arg1, arg2, ...)\n    \n    local start, duration, enable = GetSpellCooldown(47540)\n    \n    if start and duration then -- the spell is on cooldown\n        local getTime = GetTime()\n        \n        -- start + duration gives us the value of GetTime() at the point when the cd will end\n        -- the time when the cd ends (a time in the future) minus the current time gives us the remaining duration on the cooldown\n        local remainingCD = start + duration - getTime\n        \n        -- if we're on cooldown and the total cooldown is greater than 2 seconds\n        -- this filters out global cooldown spells or spells whose cds are otherwise irrelevant\n        \n        if remainingCD > 0  and duration > 2 then\n            return true\n        end\n    end\n    return false\nend",
			},
			["anchorPoint"] = "CENTER",
			["activeTriggerMode"] = -10,
			["customTextUpdate"] = "update",
		...
		["Warlock Summon Doomguard"] = {
			...
			["trigger"] = {
				...
				["realSpellName"] = "Summon Doomguard",
				["use_spellName"] = true,
				["subeventPrefix"] = "SPELL",
				["use_unit"] = true,
				["showOn"] = "showAlways",
		...
		["Mage Time Warp"] = {
			...
			["fontSize"] = 15,
			["displayStacks"] = "%s",
			["customTriggerLogic"] = "function(trigger)\n    if(trigger[1]) then\n        WeakAuras.regions[aura_env.id].region.icon:SetTexture(\"Interface\\\\Icons\\\\spell_nature_sleep\")\n        WeakAuras.regions[aura_env.id].region.icon:SetDesaturated(true);\n        return true;\n    end\n    start, duration, enable = GetSpellCooldown(\"Time Warp\");\n    --if(not start) then\n    --WeakAuras.regions[aura_env.id].region.icon:SetTexture(\"Interface\\\\Icons\\\\ability_shaman_heroism\")\n    WeakAuras.regions[aura_env.id].region.icon:SetDesaturated(false);\n    return true;\n    -- end\n    --return false;\nend",
			["regionType"] = "icon",
			["icon"] = true,
			["desaturate"] = false,
			["cooldown"] = true,
		...
		["Paladin Guardian of Ancient Kings"] = {
			...
			["inverse"] = true,
			["id"] = "Paladin Guardian of Ancient Kings",
			["parent"] = "DPS Cooldowns",
			["displayIcon"] = 1269862,
			["cooldown"] = true,
			["textColor"] = {
		...
		["Tichodrius Carrion Essence of Night"] = {
			["disjunctive"] = "all",
			["untrigger"] = {
			},
			["anchorPoint"] = "CENTER",
			...
			["id"] = "Tichodrius Carrion Essence of Night",
			["yOffset"] = 306.325012207031,
			["frameStrata"] = 1,
			["width"] = 100,
			["parent"] = "Nighthold",
		...
		["Krosus Beams"] = {
			["outline"] = "OUTLINE",
			["fontSize"] = 60,
			["xOffset"] = 9.56298828125,
			["displayText"] = "%c",
			["customText"] = "function()            \n    if WeakAuras.IsOptionsOpen() then\n        return \"|cFF00FF00LEFT SAVE\"\n    else\n        local result = \"\"\n        \n        \n        if aura_env.mode ==\"left\" then\n            if aura_env.Beam == 1 or aura_env.Beam == 3 or aura_env.Beam == 5 or aura_env.Beam == 7 or aura_env.Beam == 9 or aura_env.Beam == 11 or aura_env.Beam == 13 or aura_env.Beam == 15 or aura_env.Beam == 17 or aura_env.Beam == 19 then\n                result = \"|cFFFF0000RIGHT SAFE\"\n            else result = \"|cFF00FF00LEFT SAFE\"\n            end\n        end\n        \n        if aura_env.mode ==\"right\" then\n            if aura_env.Beam == 1 or aura_env.Beam == 3 or aura_env.Beam == 5 or aura_env.Beam == 7 or aura_env.Beam == 9 or aura_env.Beam == 11 or aura_env.Beam == 13 or aura_env.Beam == 15 or aura_env.Beam == 17 or aura_env.Beam == 19 then\n                result = \"|cFF00FF00LEFT SAFE\"\n            else result = \"|cFFFF0000RIGHT SAFE\"\n            end\n        end\n        \n        \n        return result\n    end\n    \n    \n    \nend\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n",
			["yOffset"] = 332.903686523438,
			["regionType"] = "text",
			["parent"] = "Nighthold",
			["activeTriggerMode"] = -10,
			["customTextUpdate"] = "update",
			["url"] = "https://wago.io/EJ34WlqvM",
			["actions"] = {
				["start"] = {
				},
				["init"] = {
					["custom"] = "aura_env.mode = \"\"\naura_env.Beam = 0",
					["do_custom"] = true,
				},
				["finish"] = {
					["custom"] = "aura_env.mode = \"\"\naura_env.Beam = 0",
		...
		["Paladin Shield of Vengeance"] = {
			...
			["auto"] = true,
			["inverse"] = true,
			["id"] = "Paladin Shield of Vengeance",
			["color"] = {
				1, -- [1]
				1, -- [2]
				1, -- [3]
		...
		["Track FR 5"] = {
			...
			["trigger"] = {
				...
				["event"] = "Combat Log",
				["subeventSuffix"] = "_CAST_START",
				["customDuration"] = "function()\n    local now = time()\n    -- Fifth second\n    local start_track = now-4\n    local end_track = now-5 \n    local damage_value = 0\n    for key, value in pairs(WA_TABLE) do\n        -- If the damage occured within the second,\n        -- assign it to the damage value\n        if key > end_track and key < start_track then\n            damage_value = damage_value + value or 0\n        end\n    end\n    -- For timewalking/personal preference\n    local max_fr = UnitHealthMax(\"player\")/2\n    \n    return damage_value or 0,max_fr,true    \n    \nend\n\n\n\n\n\n\n\n\n\n\n",
				["custom"] = "function()\n    return true\nend\n\n\n\n\n\n\n\n",
				["events"] = "UNIT_HEALTH",
				["spellIds"] = {
				},
		...
		["Track FR 4"] = {
			...
			["trigger"] = {
				...
				["event"] = "Combat Log",
				["subeventSuffix"] = "_CAST_START",
				["customDuration"] = "function()\n    local now = time()\n    -- Fourth second\n    local start_track = now-3\n    local end_track = now-4 \n    local damage_value = 0\n    for key, value in pairs(WA_TABLE) do\n        -- If the damage occured within the second,\n        -- assign it to the damage value\n        if key > end_track and key < start_track then\n            damage_value = damage_value + value or 0\n        end\n    end\n    -- For timewalking/personal preference\n    local max_fr = UnitHealthMax(\"player\")/2\n    \n    return damage_value or 0,max_fr,true    \n    \nend\n\n\n\n\n\n\n\n\n\n\n",
				["events"] = "UNIT_HEALTH",
				["custom"] = "function()\n    return true\nend\n\n\n\n\n\n\n\n",
				["spellIds"] = {
				},
		...
		["Ms_Number"] = {
			...
			["displayText"] = "%c",
			["customText"] = "function()\n    local curMs = UnitPower('player',11)\n    local Predict_Ms = 0\n    local Predict_non_fill = 0\n    local SpellCast = UnitCastingInfo('player')\n    \n    if select(1,SpellCast) == 'Lightning Bolt'  then\n        Predict_Ms = 8\n    elseif select(1,SpellCast) == 'Lava Burst' then\n        Predict_Ms = 12\n    elseif select(1,SpellCast) == 'Icefury' then\n        Predict_Ms = 24\n    end   \n    \n    E = abs(curMs)+(Predict_Ms) or 0\n    \n    if E >= 100 then\n        E = 100\n    end\n    if E <= 0 then\n        E = 0\n    end\n    \n    return E\n    \nend",
			["untrigger"] = {
				["unit"] = "player",
				["use_unit"] = true,
			},
			...
			["font"] = "Prototype",
			["numTriggers"] = 1,
			["width"] = 9.20995998382568,
			["height"] = 18.4199199676514,
			["id"] = "Ms_Number",
			["load"] = {
				["use_never"] = false,
				["talent"] = {
		...
		["Wisdom raiders need this"] = {
			...
			["justify"] = "LEFT",
			["selfPoint"] = "BOTTOM",
			["id"] = "Wisdom raiders need this",
			["width"] = 538.270935058594,
			["frameStrata"] = 1,
			["anchorFrameType"] = "SCREEN",
			["xOffset"] = -5.62841796875,
			["font"] = "Friz Quadrata TT",
			["numTriggers"] = 1,
			["yOffset"] = 55.77197265625,
			["height"] = 71.6330108642578,
			["trigger"] = {
				["type"] = "status",
				["subeventSuffix"] = "_CAST_START",
				["percenthealth"] = "0",
		...
		["DPS Cooldowns"] = {
			["grow"] = "LEFT",
			["controlledChildren"] = {
				"Death Knight Empower Rune Weapon", -- [1]
				"Death Knight Vampiric Blood", -- [2]
				"Death Knight Anti-Magic Shell", -- [3]
				"Death Knight Dancing Rune Weapon", -- [4]
				"Death Knight Pillar of Frost", -- [5]
				"Death Knight Obliteration", -- [6]
				"Demon Hunter Meta", -- [7]
				"Druid Survival Instincts", -- [8]
				"Druid FR", -- [9]
				"Druid Barkskin", -- [10]
				"Druid Rage of the Sleeper", -- [11]
				"Hunter Trueshot", -- [12]
				"Hunter TItans Thunder", -- [13]
				"Mage Pet Ability", -- [14]
				"Mage Frozen Orb", -- [15]
				"Mage Mirror Image", -- [16]
				"Mage Icy Veins", -- [17]
				"Mage Time Warp", -- [18]
				"Monk FB", -- [19]
				"Monk Zen Med", -- [20]
				"Rogue Shadow Blades", -- [21]
				"Paladin AW", -- [22]
				"Paladin Shield of Vengeance", -- [23]
				"Paladin Ardent Defender", -- [24]
				"Paladin Guardian of Ancient Kings", -- [25]
				"Priest Void Torret", -- [26]
				"Priest Void Shadow Fiend", -- [27]
				"Priest Void Shadow Fiend 2", -- [28]
				"Shaman Doomhammer", -- [29]
				"Shaman Wolves", -- [30]
				"Shaman Hero", -- [31]
				"Warlock Grimoire", -- [32]
				"Warlock Summon Doomguard", -- [33]
				"Warlock Summon Infernal", -- [34]
				"Warrior Last Stand", -- [35]
				"Warrior Shield Wall", -- [36]
				"Warrior Demo Shout", -- [37]
				"Warrior Spell Reflect", -- [38]
			},
			["disjunctive"] = "all",
			["yOffset"] = -250,
			["anchorPoint"] = "CENTER",
		...
		["Priest Sanctify"] = {
			...
			["untrigger"] = {
				["custom"] = "function(event, arg1, arg2, ...)\n    \n    local start, duration, enable = GetSpellCooldown(34861)\n    \n    if start and duration then -- the spell is on cooldown\n        local getTime = GetTime()\n        \n        -- start + duration gives us the value of GetTime() at the point when the cd will end\n        -- the time when the cd ends (a time in the future) minus the current time gives us the remaining duration on the cooldown\n        local remainingCD = start + duration - getTime\n        \n        -- if we're on cooldown and the total cooldown is greater than 2 seconds\n        -- this filters out global cooldown spells or spells whose cds are otherwise irrelevant\n        \n        if remainingCD > 0  and duration > 2 then\n            return true\n        end\n    end\n    return false\nend",
			},
			["anchorPoint"] = "CENTER",
			["activeTriggerMode"] = -10,
			["customTextUpdate"] = "update",
		...
		["Maelstrom Predict Bar"] = {
			...
			["trigger"] = {
				...
				["lunar_power_operator"] = ">=",
				["subeventSuffix"] = "_CAST_START",
				["customDuration"] = "function()\n    local curMs = UnitPower('player',11)\n    local Predict_Ms = 0\n    local Predict_non_fill = 0\n    local SpellCast = UnitCastingInfo('player')\n    \n    if select(1,SpellCast) == 'Lightning Bolt' and UnitBuff('player','Power of the Maelstrom')  then\n        Predict_Ms = 14\n    elseif select(1,SpellCast) == 'Lightning Bolt' then\n        Predict_Ms = 8\n    elseif select(1,SpellCast) == 'Lava Burst' then\n        Predict_Ms = 12\n    elseif select(1,SpellCast) == 'Icefury' then\n        Predict_Ms = 24\n    end   \n    \n    local M = abs(curMs)+(Predict_Ms) or 0   \n    \n    M=math.min(M,100)\n    \n    WeakAuras.ScanEvents(\"Maelstrom\",M)        \n    return M,100,0,0\nend",
				["custom"] = "function()\n    return true\nend",
				["spellIds"] = {
				},
				["unevent"] = "custom",
		...
		["FR Lite percentage with tracking"] = {
			["backdropColor"] = {
				1, -- [1]
				1, -- [2]
				1, -- [3]
			...
			["controlledChildren"] = {
				...
				"Track FR 4", -- [4]
				"Track FR 5", -- [5]
				"FR percentage Health Lite ", -- [6]
			},
			["borderBackdrop"] = "Blizzard Tooltip",
			["xOffset"] = -183.996887207031,
			["border"] = false,
			["yOffset"] = 150.122680664063,
			["regionType"] = "group",
			["borderSize"] = 16,
			["activeTriggerMode"] = -10,
			["expanded"] = false,
			...
			["selfPoint"] = "BOTTOMLEFT",
			["id"] = "FR Lite percentage with tracking",
			["disjunctive"] = "all",
			["frameStrata"] = 1,
			["anchorFrameType"] = "SCREEN",
			["animation"] = {
		...
		["Hunter Cheetah"] = {
			...
			["trigger"] = {
				...
				["realSpellName"] = "Aspect of the Cheetah",
				["use_spellName"] = true,
				["spellName"] = 186257,
				["use_unit"] = true,
				["showOn"] = "showAlways",
		...
		["PriestHolyIcons"] = {
			...
			["controlledChildren"] = {
				"Velen's Future Sight", -- [1]
				"Perfectly Preserved Cake", -- [2]
				"Priest H:Sanctuary", -- [3]
				"HPriest Serenity", -- [4]
				"HPriest Light of T'uure", -- [5]
				"HPriest PoM", -- [6]
				"HPriest CoH", -- [7]
				"HPriest DS", -- [8]
				"HPriest Halo", -- [9]
		...
		["RNGESUS"] = {
			...
			["fontSize"] = 19,
			["disjunctive"] = "all",
			["displayText"] = "FURY OF RNGESUS\n",
			["yOffset"] = 50.0007781982422,
			["regionType"] = "text",
			["color"] = {
				1, -- [1]
				0, -- [2]
			...
			["actions"] = {
				["start"] = {
					["do_glow"] = false,
					["glow_frame"] = "WeakAurasDisplayButton118",
					["do_message"] = true,
					["glow_action"] = "hide",
					["message_type"] = "YELL",
					["message"] = "FEEL THE FURY OF RNGESUS !",
					["sound"] = "Interface\\AddOns\\WeakAuras\\Media\\Sounds\\BoxingArenaSound.ogg",
					["do_sound"] = true,
				},
				["init"] = {
			...
			["anchorFrameType"] = "SCREEN",
			["frameStrata"] = 1,
			["width"] = 206.712326049805,
			["untrigger"] = {
			},
			["font"] = "Friz Quadrata TT",
			["numTriggers"] = 6,
			["anchorPoint"] = "CENTER",
			["height"] = 38.8864822387695,
			["animation"] = {
				["start"] = {
					["type"] = "none",
					["duration_type"] = "seconds",
		...
		["Elemental Maelstrom Bar"] = {
			...
			["controlledChildren"] = {
				"Maelstrom Bar", -- [1]
				"Maelstrom Predict Bar", -- [2]
				"Mana Bar", -- [3]
				"Ms_Number", -- [4]
			},
			["borderBackdrop"] = "Blizzard Tooltip",
			["xOffset"] = 2.0467529296875,
			["border"] = false,
			["yOffset"] = -245.763946533203,
			["regionType"] = "group",
			["borderSize"] = 16,
			["activeTriggerMode"] = 0,
			["expanded"] = false,
		...
		["Druid Swiftmend"] = {
			["disjunctive"] = "all",
			["untrigger"] = {
				["custom"] = "function(event, arg1, arg2, ...)\n    \n    local start, duration, enable = GetSpellCooldown(18562)\n    \n    if start and duration then -- the spell is on cooldown\n        local getTime = GetTime()\n        \n        -- start + duration gives us the value of GetTime() at the point when the cd will end\n        -- the time when the cd ends (a time in the future) minus the current time gives us the remaining duration on the cooldown\n        local remainingCD = start + duration - getTime\n        \n        -- if we're on cooldown and the total cooldown is greater than 2 seconds\n        -- this filters out global cooldown spells or spells whose cds are otherwise irrelevant\n        \n        if remainingCD > 0  and duration > 2 then\n            return true\n        end\n    end\n    return false\nend",
			},
			["anchorPoint"] = "CENTER",
			["activeTriggerMode"] = -10,
			["customTextUpdate"] = "update",
		...
		["Skorpyron Broken Shard"] = {
			...
			["fontSize"] = 31,
			["displayStacks"] = "You are SAFE from Shockwave",
			["regionType"] = "icon",
			["desaturate"] = false,
			["xOffset"] = -254.906127929688,
			["stacksContainment"] = "OUTSIDE",
		...
		["Druid Wild Growth"] = {
			...
			["untrigger"] = {
				["custom"] = "function(event, arg1, arg2, ...)\n    \n    local start, duration, enable = GetSpellCooldown(48438)\n    \n    if start and duration then -- the spell is on cooldown\n        local getTime = GetTime()\n        \n        -- start + duration gives us the value of GetTime() at the point when the cd will end\n        -- the time when the cd ends (a time in the future) minus the current time gives us the remaining duration on the cooldown\n        local remainingCD = start + duration - getTime\n        \n        -- if we're on cooldown and the total cooldown is greater than 2 seconds\n        -- this filters out global cooldown spells or spells whose cds are otherwise irrelevant\n        \n        if remainingCD > 0  and duration > 2 then\n            return true\n        end\n    end\n    return false\nend",
			},
			["anchorPoint"] = "CENTER",
			["activeTriggerMode"] = -10,
			["customTextUpdate"] = "update",
		...
		["UseNows"] = {
			...
			["controlledChildren"] = {
				...
				"Mage Missing Pet", -- [4]
				"DK Missing Pet", -- [5]
				"Hunter Missing Pet", -- [6]
				"Warlock Pet MIssing", -- [7]
				"Ret BoK", -- [8]
				"Druid Use Mark of Usrol", -- [9]
				"Mage Use Living Bomb", -- [10]
				"Mage Blizzard", -- [11]
				"Priest PWS", -- [12]
				"Priest PoM", -- [13]
				"Priest Sanctify", -- [14]
				...
				"Priest PtW", -- [19]
				"Priest Disc SWP", -- [20]
				"Shaman Flametongue", -- [21]
				"Shaman Boulderfist", -- [22]
				"Shaman Stormstrike", -- [23]
				"Shaman Crash Lightning", -- [24]
				"Shaman Lava Lash", -- [25]
				"DK Defile", -- [26]
				"Mage Water Jet", -- [27]
			},
		...
		["Stagger"] = {
			["xOffset"] = -268.112243652344,
			["customText"] = "function()\n    return (UnitStagger(\"player\") or 0)/10\nend",
			["untrigger"] = {
			},
			["anchorPoint"] = "CENTER",
			["activeTriggerMode"] = 0,
		...
		["Proc Buffs"] = {
			["grow"] = "LEFT",
			["controlledChildren"] = {
				"All - Stampeding Roar", -- [1]
				"All - Feather", -- [2]
				"All - Concordance", -- [3]
				"Healer - Symbol", -- [4]
				"Healer -Innervate", -- [5]
				"Druid Ironfur", -- [6]
				"Druid Mark of Ursol", -- [7]
				"Hunter  AotW", -- [8]
				"Hunter  BW", -- [9]
				"Mage - Icy Veins", -- [10]
				"Rogue - SoD", -- [11]
				...
				"Priest -Divinity", -- [13]
				"Priest Velens", -- [14]
				"Priest - Apotheosis", -- [15]
				"Priest - T'uure", -- [16]
				"Priest - BT", -- [17]
				"Priest - Power of the Dark Side", -- [18]
				"Priest - Speed of the Pious", -- [19]
				"Priest - Rapture", -- [20]
				"Warlock - Backdraft", -- [21]
				"Warrior - Shield Block", -- [22]
				"Warrior - Ignore Pain", -- [23]
			},
			["xOffset"] = -225,
			["yOffset"] = -140,
			["anchorPoint"] = "CENTER",
		...
		["Death Knight Anti-Magic Shell"] = {
			...
			["auto"] = true,
			["parent"] = "DPS Cooldowns",
			["id"] = "Death Knight Anti-Magic Shell",
			["numTriggers"] = 1,
			["frameStrata"] = 1,
			["anchorFrameType"] = "SCREEN",
			["color"] = {
		...
		["FR percentage Health Lite "] = {
			...
			["animation"] = {
				...
				["main"] = {
					...
					["colorG"] = 0,
					["colorB"] = 0,
					["colorFunc"] = "return function()\n    if WA_GRELORNE_PERCENTAGE_HEAL < 10 then\n        return 0,255,0    \n    elseif WA_GRELORNE_PERCENTAGE_HEAL >= 10 and WA_GRELORNE_PERCENTAGE_HEAL < 30 then\n        return 255,255,0 \n    elseif WA_GRELORNE_PERCENTAGE_HEAL >= 30 then\n        return 255,0,0\n    end\nend\n\n\n\n\n\n\n",
					["rotate"] = 0,
					["scalex"] = 1,
					["colorR"] = 0,
				},
		...
		["Nighthold"] = {
			["grow"] = "HORIZONTAL",
			["controlledChildren"] = {
				"Elisande Slow Time", -- [1]
				"Elisande Conflex", -- [2]
				"Elisande Fast Time", -- [3]
				"Chronomatic Anomaly Time Bomb", -- [4]
				"Spellblade Aluriel", -- [5]
				"Helya Taint", -- [6]
				"Tichodrius Carrion Plague", -- [7]
				"Trilliax Cake", -- [8]
				"Tichodrius Carrion Essence of Night", -- [9]
				"Krosus Orb of Destruction", -- [10]
				"Botanist Parasitic Fetter", -- [11]
				"Botanist Parasitic Fixate", -- [12]
				"Star Augur Icy Ejection", -- [13]
				"Star Augur Fel Ejection", -- [14]
				"Skorpyron Broken Shard", -- [15]
				"Krosus Beams", -- [16]
			},
			["disjunctive"] = "all",
			["yOffset"] = -282.439300537109,
			["anchorPoint"] = "CENTER",
			["activeTriggerMode"] = -10,
			["space"] = 2,
			["background"] = "None",
			...
			["id"] = "Nighthold",
			["frameStrata"] = 1,
			["width"] = 1549.44314575195,
			["xOffset"] = -368.398010253906,
			["untrigger"] = {
			},
			["numTriggers"] = 1,
			["animation"] = {
		...
		["Priest - Power of the Dark Side"] = {
			...
			["auto"] = true,
			["desaturate"] = false,
			["id"] = "Priest - Power of the Dark Side",
			["animation"] = {
				["start"] = {
					["duration_type"] = "seconds",
					["type"] = "none",
		...
		["Priest Plea Stacks"] = {
			...
			["auto"] = false,
			["icon"] = true,
			["id"] = "Priest Plea Stacks",
			["selfPoint"] = "CENTER",
			["frameStrata"] = 1,
			["anchorFrameType"] = "SCREEN",
			["yOffset"] = 8.63629150390625,
			["numTriggers"] = 1,
			["inverse"] = false,
			["color"] = {
				1, -- [1]
		...
		["Priest Solace"] = {
			["disjunctive"] = "all",
			["untrigger"] = {
				["custom"] = "function(event, arg1, arg2, ...)\n    \n    local start, duration, enable = GetSpellCooldown(129250)\n    \n    if start and duration then -- the spell is on cooldown\n        local getTime = GetTime()\n        \n        -- start + duration gives us the value of GetTime() at the point when the cd will end\n        -- the time when the cd ends (a time in the future) minus the current time gives us the remaining duration on the cooldown\n        local remainingCD = start + duration - getTime\n        \n        -- if we're on cooldown and the total cooldown is greater than 2 seconds\n        -- this filters out global cooldown spells or spells whose cds are otherwise irrelevant\n        \n        if remainingCD > 0  and duration > 2 then\n            return true\n        end\n    end\n    return false\nend",
			},
			["anchorPoint"] = "CENTER",
			["activeTriggerMode"] = -10,
			["customTextUpdate"] = "update",
		...
		["DPS Utility"] = {
			...
			["controlledChildren"] = {
				"Death Knight IF", -- [1]
				"Death Knight Gorefiends Grasp", -- [2]
				"Death Knight CU", -- [3]
				"Demon Hunter Chaos", -- [4]
				"Demon Hunter Darkness", -- [5]
				"Demon Hunter Blur", -- [6]
				"Druid Incapacitating Roar", -- [7]
				"Druid Rebirth", -- [8]
				"Hunter AotT", -- [9]
				"Hunter Cheetah", -- [10]
				"Hunter Exhilaration", -- [11]
				"Mage Ice Barrier", -- [12]
				"Mage Ice Block", -- [13]
				"Mage Shimmer", -- [14]
				"Mage Cold Snap", -- [15]
				...
				"Rogue CoS", -- [18]
				"Rogue Sprint", -- [19]
				"Paladin Lay on Hands", -- [20]
				"Paladin Blessing of Protection", -- [21]
				"Paladin Blessing of Freedom", -- [22]
				"Paladin Hammer of Justice", -- [23]
				"Paladin Hand of Hinderance", -- [24]
				"Priest VE", -- [25]
				"Priest Dispersion", -- [26]
				"Priest Mind Bomb", -- [27]
				"Shaman LST", -- [28]
				"Shaman Wind Rush Totem", -- [29]
				"Shaman Astral Shift", -- [30]
				"Warlock UR", -- [31]
				"Warlock SF", -- [32]
				"Warrior Shockwave", -- [33]
				"Warrior Heroic Leap", -- [34]
			},
			["disjunctive"] = "all",
			["yOffset"] = -250,
			["anchorPoint"] = "CENTER",
		...
		["Chronomatic Anomaly Time Bomb"] = {
			...
			["id"] = "Chronomatic Anomaly Time Bomb",
			["anchorFrameType"] = "SCREEN",
			["frameStrata"] = 1,
			["width"] = 100,
			["color"] = {
		...
		["Elondre's roll the bones"] = {
			...
			["activeTriggerMode"] = -10,
			["expanded"] = false,
			["xOffset"] = 32.4769897460938,
			["yOffset"] = -371.143844604492,
			["borderOffset"] = 5,
			["anchorPoint"] = "CENTER",
			["selfPoint"] = "BOTTOMLEFT",
			["additional_triggers"] = {
		...
		["Insanity Bar - Text - Middle"] = {
			...
			["disjunctive"] = "all",
			["displayText"] = "%c",
			["customText"] = "-- DEBUG: Insanity Bar - Text - Middle - CustomText -- 2017/05/31\n-- Insanity Bar -- By Twintop - Illidan-US\n-- HowToPriest Thread -- https://howtopriest.com/viewtopic.php?f=104&t=8339\n-- WAGO.IO Link -- https://wago.io/4yfC0kJVW\nfunction()\n    WA_Voidform_Current_Drain_Rate = WA_Voidform_Current_Drain_Rate or 0;\n    WA_Insanity_Bar_LI_Last_Count = WA_Insanity_Bar_LI_Last_Count or 0;\n    local _, _, _, liCount, _, liDuration, _, _, _, _, liSpellId = UnitBuff(\"player\",GetSpellInfo(197937));\n    WA_Insanity_Bar_Color_Text_Middle = WA_Insanity_Bar_Color_Text_Middle or \"00FFFFFF\";\n    \n    local returnString =  string.format(\"|c%s\", WA_Insanity_Bar_Color_Text_Middle);\n    \n    if WA_Insanity_getRemainingTimeAndStackCount ~= nil then\n        local remainingTime, stackCount, moreStacks = WA_Insanity_getRemainingTimeAndStackCount(); \n        \n        if WA_Voidform_Current_Drain_Rate == 0 then\n            if (WA_Insanity_Bar_Show_Middle_Lingering_Insanity_Stacks_Middle or WA_Insanity_Bar_Show_Middle_Lingering_Insanity_Time_Middle) and liCount ~= nil and liCount > 0 then\n                if WA_Insanity_Bar_Show_Middle_Lingering_Insanity_Stacks_Middle then\n                    returnString = returnString .. string.format(\"%.0f LI\", liCount);\n                end\n                \n                if WA_Insanity_Bar_Show_Middle_Lingering_Insanity_Stacks_Middle and WA_Insanity_Bar_Show_Middle_Lingering_Insanity_Time_Middle then\n                    returnString = returnString .. string.format(\" - \");    \n                end\n                \n                if WA_Insanity_Bar_Show_Middle_Lingering_Insanity_Stacks_Middle then\n                    \n                    local timeleft = liDuration;\n                    \n                    local timeleft = liCount / 2;\n                    \n                    if mod(liCount, 2) == 1 then\n                        timeleft = timeleft + 0.5;\n                    end                    \n                    \n                    timeleft = timeleft - (GetTime() - WA_Insanity_Bar_LI_Last_Tick);\n                    \n                    returnString = returnString .. string.format(\"%.1f sec\", timeleft);\n                    \n                end\n                \n            end\n        else\n            \n            if WA_Insanity_Bar_Show_Middle_Voidform_Time_Remaining then\n                returnString = returnString .. string.format(\"%.1f sec\", remainingTime);\n            end \n            \n            if WA_Insanity_Bar_Show_Middle_Voidform_Time_Remaining and WA_Insanity_Bar_Show_Middle_Voidform_Current_Drain then\n                returnString = returnString .. string.format(\" - \");\n            end\n            \n            if WA_Insanity_Bar_Show_Middle_Voidform_Current_Drain then                \n                returnString = returnString .. string.format(\"%.1f/sec\", WA_Voidform_Current_Drain_Rate);\n            end\n        end\n        \n    end\n    \n    return returnString;\nend\n\n\n\n\n\n\n\n\n\n",
			["untrigger"] = {
			},
			["regionType"] = "text",
			["xOffset"] = 0,
