...
WeakAurasSaved = {
	...
	["displays"] = {
		...
		["Interrupts and Dispells"] = {
			...
			["animate"] = false,
			["xOffset"] = 20.2493896484375,
			["regionType"] = "dynamicgroup",
			["border"] = "None",
			["yOffset"] = 608.14892578125,
			["anchorPoint"] = "BOTTOM",
			["actions"] = {
				["start"] = {
				},
	...
	["frame"] = {
		["xOffset"] = -138.663818359375,
		["yOffset"] = -95.7911987304688,
