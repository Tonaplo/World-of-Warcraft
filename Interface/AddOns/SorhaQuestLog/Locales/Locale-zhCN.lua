...
L["Account"] = "账户" -- Needs review
L["Achievement Description"] = "成就描述" -- Needs review
...
L["Achievement Padding"] = "成就间距" -- Needs review
L["Achievement Settings"] = "成就设置" -- Needs review
L["Achievement Task"] = "成就任务"
L["Achievement Titles"] = "成就标题"
L["Achievement Tracker"] = "成就追踪器" -- Needs review
...
L["Adjust the scale of the minion"] = "调节小部件的缩放" -- Needs review
L["Adjust the width of the minion"] = "调节小部件的宽度" -- Needs review
...
L["Auto Hide Minion Title"] = "自动隐藏小部件标题" -- Needs review
...
L["Background Texture"] = "背景材质" -- Needs review
...
L["Bonus Objectives"] = "奖励目标" -- Needs review
L["Border Colour"] = "边框颜色" -- Needs review
L["Border Texture"] = "边框材质" -- Needs review
...
L["Content Indent"] = "内容缩进" -- Needs review
...
L["Controls the font size this font"] = "控制此字体的字号" -- Needs review
L["Controls the level of indentation for the achievements content"] = "控制成就文字缩进的程度" -- Needs review
...
L["Controls the spacing below each line of this font"] = "控制此字体行间空隙" -- Needs review
L["Controls the width of the main window."] = "更改主窗口宽度" -- Needs review
L["Controls the width of the minion"] = "更改" -- Needs review
L["Count/Max Header"] = "计数/最大数 小标题" -- Needs review
...
L["Display POI Tag in Quest Title"] = "在任务标题中显示兴趣点标签" -- Needs review
L["Display quest description if not objectives"] = "无任务目标时显示任务描述" -- Needs review
L["Display Quest Name"] = "显示任务名称" -- Needs review
...
L["Displays the POI Tag used on the world map for in the title"] = "将世界地图上的兴趣点标签显示在标题中" -- Needs review
L["Display the text of an objective after numbers"] = "在数字之后显示目标文本" -- Needs review
...
]=] ] = "当解锁时，拖动这里移动场景任务小部件" -- Needs review
L["Enable Minion"] = "允许小部件" -- Needs review
...
L["Font Line Spacing"] = "行空隙" -- Needs review
L["Font Outline"] = "字体描边" -- Needs review
L["Fonts"] = "字体" -- Needs review
...
L["Global Textures"] = "全局材质" -- Needs review
L[" (goto)"] = "(导向)"
...
L["Header Font Settings"] = "题头字体设置" -- Needs review
...
L["Hide the title when there is nothing to display"] = "没有可显示的东西时，隐藏标题" -- Needs review
...
L["Info Text Font Settings"] = "信息文本设置" -- Needs review
...
L["Misc. Settings"] = "音效设定" -- Needs review
L["Monochrome Outline"] = "单色描边" -- Needs review
...
L["Objective Changed Sound"] = "目标变更提示音" -- Needs review
...
L["Objective Font Settings"] = "任务目标字体设置" -- Needs review
...
L["Objective Text Last"] = "目标文本最后" -- Needs review
L["Objective title colour"] = "目标标题颜色" -- Needs review
L["Objective Tooltip Text"] = "目标提示文本" -- Needs review
...
L["Padding After Quest"] = "任务后部填充空间" -- Needs review
...
L["Quest Font Settings"] = "任务字体设置" -- Needs review
...
L["Quest Sort Order:"] = "任务归类顺序" -- Needs review
...
L["Quest Tracker Settings"] = "任务追踪器设置" -- Needs review
...
L["Remote Quests Tracker"] = "远程任务追踪器" -- Needs review
...
L["Scenario Headers"] = "场景标题" -- Needs review
L["Scenario Objectives"] = "场景目标" -- Needs review
L["Scenario Quests"] = "场景任务" -- Needs review
L["Scenario Quests Minion Anchor"] = "场景任务小部件锚点" -- Needs review
L["Scenario Settings"] = "场景设定" -- Needs review
L["Scenario Tasks"] = "场景任务" -- Needs review
L["Scenario Tracker"] = "场景追踪器" -- Needs review
L["Scenario Tracker Title"] = "场景追踪器标题" -- Needs review
L["Sets the color for Achievement Description"] = "设置成就描述文字的颜色" -- Needs review
...
L["Sets the color for In Progress Achievement Objectives"] = "设置进行中的成就目标的颜色" -- Needs review
L["Sets the color for Minion Title"] = "设置小部件标题颜色" -- Needs review
...
L["Sets the color for Scenario Headers"] = "设置场景题头颜色" -- Needs review
L["Sets the color for Scenario Objectives"] = "设置场景目标颜色" -- Needs review
L["Sets the color for Scenario Tasks"] = "设置场景任务颜色" -- Needs review
L["Sets the color for the completed part of the achievement status bars"] = "为成就状态栏已完成部分设定颜色" -- Needs review
L["Sets the color for the completed part of the status bar"] = "设置已完成部分状态条颜色" -- Needs review
L["Sets the color for the completed part status bars"] = "为状态条的已完成部分设置颜色" -- Needs review
...
L["Sets the color for the objective text in the quests tooltip"] = "设置任务提示中目标文本的颜色" -- Needs review
...
L["Sets the color for the un-completed part of status bars"] = "为状态条的未完成部分设置颜色" -- Needs review
L["Sets the color for the un-completed part of the achievement status bars"] = "为成就状态栏的未完成部分设定颜色" -- Needs review
L["Sets the color for the un-completed part of the status bar"] = "设置未完成部分状态条颜色" -- Needs review
...
L["Sets the LDB and minion header counts to questcount/max instead of count/completed"] = "将LDB和minion计数方式由计数/已完成数 变为计数/总数" -- Needs review
...
L["Status Bar Settings"] = "状态条设置" -- Needs review
...
L["Task Font Settings"] = "任务字体设置" -- Needs review
L["Task Font Size"] = "任务字体大小" -- Needs review
L["Task In Progress"] = "进行中的任务" -- Needs review
...
L["The amount of extra padding after an Achievement before the next."] = "两个成就的间距" -- Needs review
L["The amount of extra padding after a quest before the next text."] = "任务后部在下一部分文本前额外加入的空白" -- Needs review
...
L["The font used for this element"] = "用于这个元素的字体" -- Needs review
L["The length of the quest tags (d, p, g5, ELITE etc)"] = "任务标签的长度(d，p，g5，精英，等等)" -- Needs review
L["The minion to anchor this minion to"] = "将这个子版块挂靠至" -- Needs review
...
L["The outline that this font will use"] = "用于这个字体的描线" -- Needs review
...
L["The sort order of quests, within each zone"] = "各个区域内任务整理的顺序" -- Needs review
L["The sound played when a quests objective changes"] = "当一个任务目标发生变更是播放此声音" -- Needs review
...
L["The texture the status bars will use"] = "状态条材质" -- Needs review
L["The texture used for the minion backgrounds"] = "子版块背景使用的材质" -- Needs review
L["The texture used for the minion borders"] = "子版块边框使用的材质" -- Needs review
L["The texture used for the status bars"] = "状态条材质" -- Needs review
...
L["Uses status bars for progress bar type objectives"] = "在使用进度条的任务中启用状态条" -- Needs review
...
L["What to do when entering a pet battle"] = "进入宠物战斗后的行为" -- Needs review
L["What to do when entering a Raid"] = "进入团队时做什么" -- Needs review
L["What to do when entering combat"] = "进入战斗时做什么" -- Needs review
L["What to do when leaving a pet battle"] = "离开宠物战斗后的行为" -- Needs review
...
L["When entering pet battle"] = "当进入宠物战斗" -- Needs review
L["When leaving combat"] = "离开战斗时" -- Needs review
L["When leaving pet battle"] = "当离开宠物战斗" -- Needs review
...
L["Zone Font Settings"] = "区域字体设置" -- Needs review
