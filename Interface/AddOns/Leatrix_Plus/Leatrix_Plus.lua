...
----------------------------------------------------------------------
	...
	LeaPlusLC:MakeCB(LeaPlusLC[pg], "EnhanceMap"				, 	"Enhance world map"				, 	146, -92, 	true,	"If checked, additional functionality will be added to the world map frame.|n|nCharacter and cursor coordinates will be shown at the top, map fading will be disabled and the map reading emote will be disabled.")
