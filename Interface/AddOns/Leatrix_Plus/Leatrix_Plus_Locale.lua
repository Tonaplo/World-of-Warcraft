...
L["If checked, unexplored areas will be revealed, old dungeon and raid locations will be shown, coordinates will be shown, map fading will be disabled and the map reading emote will be disabled."] = "勾選後，未探索區域將被揭露，舊地城與團隊所在地將會顯示，座標也會顯示，地圖淡出以及地圖讀取表請都將被禁用。"
