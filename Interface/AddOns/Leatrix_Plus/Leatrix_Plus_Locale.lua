...
L["If checked, unexplored areas will be revealed, coordinates will be shown at the top of the map, map fading will be disabled and the map reading emote will be disabled."] = "勾選後，未探索的區域將可以展現，座標會顯示在地圖的頂部，地圖淡出以及地圖讀取表情都會停用。"
