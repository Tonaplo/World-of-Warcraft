...
L["Disable map emote"] = "禁用地图查看表情"
L["Disable map fade"] = "禁用地图淡出"
...
L["If checked, the minimap title bar and the calendar button will be hidden.  Right-clicking the tracking button will open the calendar.|n|nIn addition, you will be able to rescale the minimap and use the mousewheel to zoom."] = "勾选后，小地图的标题栏和日历按钮将被隐藏，改成右键点击追踪按钮打开日历。|n|n此外，你还可以缩放小地图，并使用鼠标滚轮来缩放内容显示。"
...
L["If checked, the world map will no longer fade while your character is moving."] = "勾选后，当你人物移动时，世界地图不再淡出。"
...
L["If checked, your character will not perform the reading emote when you open the world map."] = "勾选后，当你打开世界地图时，人物不再有一个阅读的动作。"
...
L["If checked, the world map will no longer fade while your character is moving."] = "勾選後，當你的角色移動時世界地圖不再淡出。"
...
L["If checked, your character will not perform the reading emote when you open the world map."] = "勾選後，當你開啟世界地圖時不再有閱讀表情。"
