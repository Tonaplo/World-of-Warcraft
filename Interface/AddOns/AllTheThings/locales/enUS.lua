...
--		[-] = "Interface\\Icons\\", -- 		
		...
		[-9] = "Interface\\Icons\\TRADE_ARCHAEOLOGY", 							-- Cache of Madness 
		...
		[-20] = "Interface\\Icons\\achievement_level_110",
		...
		[-38] = "Interface\\Icons\\Trade_BlackSmithing", 						-- Profession
		[-39] = "Interface\\Icons\\Achievement_Quests_Completed_06", 			-- Quest
		[-40] = "Interface\\Icons\\Inv_misc_book_17", 							-- Legacy
		[-41] = "Interface\\BUTTONS\\UI-GROUPLOOT-PASS-DOWN", 					-- Unobtainable
		[-43] = "Interface\\Icons\\trade_tailoring",
		[-44] = "Interface\\Icons\\inv_misc_armorkit_17",
		[-45] = "Interface\\Icons\\inv_belt_mail_raidhuntermythic_r_01",
		[-46] = "Interface\\Icons\\trade_blacksmithing",
		[-66] = "Interface\\Icons\\PetJournalPortrait ", 						-- Pet Battle
		[-71] = "Interface\\Icons\\trade_mining",								-- Mining
		...
		[-91] = "Interface\\Icons\\INV_Misc_Dust_02",
		...
		[-137] = "Interface\\Icons\\achievement_garrison_invasion_silver", 		-- Bronze-Silver
		[-138] = "Interface\\Icons\\achievement_garrison_invason_platinum", 	-- Gold-Platinum
		...
		[-153] = "Interface\\Icons\\expansionicon_classic",
		[-154] = "Interface\\Icons\\expansionicon_burningcrusade",
		[-155] = "Interface\\Icons\\expansionicon_wrathofthelichking",
		[-156] = "Interface\\Icons\\expansionicon_cataclysm",
		[-157] = "Interface\\Icons\\expansionicon_mistsofpandaria",
		[-158] = "Interface\\Icons\\achievement_boss_hellfire_archimonde",
		[-159] = "Interface\\Icons\\achievements_zone_brokenshore",
		...
		[-363] = "Interface\\Icons\\achievement_reputation_argentchampion", 
		[-318] = "Interface\\Icons\\inv_icon_heirloomtoken_armor02",
		[-319] = "Interface\\Icons\\inv_icon_heirloomtoken_weapon02",
		[-494] = "Interface\\Icons\\Ability_Shaman_Ascendance",
		[-1000] = "Interface\\Icons\\achievement_transmog_collections",
		[-1001] = "Interface\\Icons\\Racial_Dwarf_FindTreasure",
		[-3183] = "Interface\\Icons\\achievement_boss_hakkar",
		[-3181] = "Interface\\Icons\\achievement_boss_ossiriantheunscarred",
		[-3198] = "Interface\\Icons\\inv_misc_beer_01",
		[-3199] = "Interface\\Icons\\ability_mage_firestarter",	
		[-3226] = "Interface\\Icons\\inv_helmet_30",
		[-3227] = "Interface\\Icons\\inv_boots_02",
		[-3228] = "Interface\\Icons\\inv_chest_cloth_43",
		[-3229] = "Interface\\Icons\\inv_chest_leather_03",
		[-3230] = "Interface\\Icons\\inv_chest_leather_05",
		[-3231] = "Interface\\Icons\\inv_chest_chain_15",		
		...
		[-6012] = "Interface\\Icons\\achievement_bg_masterofallbgs",
		[-5350] = "Interface\\Icons\\ability_bossmagistrix_timewarp1",
		[-3187] = "Interface\\Icons\\creatureportrait_mageportal_undercity",
		[-5349] = "Interface\\Icons\\achievement_challengemode_scarletmonastery_gold",
		[-4189] = "Interface\\Icons\\achievement_legionpvptier4",
		[-5352] = "Interface\\Icons\\creatureportrait_portal_eyeofthestormhorde",
	};
	["NPC_ID_NAMES"] = {
	...
	-- Commonly used 
		...
		[-38] = BATTLE_PET_SOURCE_4,								-- Profession
		[-39] = BATTLE_PET_SOURCE_2,								-- Quest
...
-- World Events
		...
		[-51] = "Noblegarden",
		[-52] = "Children's Week",
		[-53] = "Midsummer Fire Festival [Alliance]",
		[-54] = "Midsummer Fire Festival [Horde]", 
		[-55] = "Pirate's Day",
		[-56] = "Brewfest",
		[-57] = "Harvest Festival",
		[-58] = "Hallow's End",
		...
		[-68] = "Kodo Mount",
		[-69] = "Reins of the Bengal Tiger",
		[-70] = "Reins of the Leopard",
		[-71] = "Mining",
...
-- Classes [Needs localization]
		...
		[-9911] = "Warrior",
		[-9912] = "Death Knight",
		[-9915] = BALANCE, 										-- Balance Spec
		[-9916] = "Feral", 
		[-9917] = STRING_SCHOOL_ELEMENTAL, 						-- Elemental Spec
		[-9918] = "Enhancement", 
		[-9949] = ITEM_QUALITY6_DESC, 							-- Artifact
		[-9950] = ARTIFACT_PRIEST_HOLY_1.." "..ARTIFACT_PRIEST_HOLY_2, 	-- Holy Priest Artifact Weapon
		[-9951] = ARTIFACT_PRIEST_DISCIPLINE, 					-- Disciple Priest Artifact Weapon
		[-9952] = ARTIFACT_PRIEST_SHADOW_WEAPONNAME, 			-- Shadow Priest Artifact Weapon
		[-9953] = ARTIFACT_MAGE_ARCANE, 						-- Arcane Mage Artifact Weapon
		[-9954] = ARTIFACT_MAGE_FIRE, 							-- Fire Mage Artifact Weapon
		[-9955] = ARTIFACT_MAGE_FROST, 							-- Frost Mage Artifact Weapon
		[-9956] = ARTIFACT_WARLOCK_AFFLICTION.." "..ARTIFACT_WARLOCK_AFFLICTION_2, -- Affliction Warlock Artifact Weapon
		[-9957] = ARTIFACT_WARLOCK_DEMO, 						-- Demonology Warlock Artifact Weapon
		[-9958] = ARTIFACT_WARLOCK_DEST, 						-- Destruction Warlock Artifact Weapon
		[-9959] = ARTIFACT_DRUID_GUARDIAN, 						-- Guardian Druid Artifact Weapon
		[-9960] = ARTIFACT_DRUID_FERAL, 						-- Feral Druid Artifact Weapon
		[-9961] = ARTIFACT_DRUID_BALANCE, 						-- Balance Druid Artifact Weapon
		[-9962] = ARTIFACT_DRUID_RESTO_WEAPONNAME, 				-- Restoration Druid Artifact Weapon
		[-9963] = ARTIFACT_ROGUE_ASSASSINATION_WEAPONNAME, 		-- Assassination Rogue Artifact Weapon
		[-9964] = ARTIFACT_ROGUE_OUTLAW_WEAPONNAME, 			-- Outlaw Rogue Artifact Weapon
		[-9965] = ARTIFACT_ROGUE_SUBTLETY_WEAPONNAME, 			-- Subtletly Rogue Artifact Weapon
		[-9966] = ARTIFACT_MONK_BREWMASTER1.." "..ARTIFACT_MONK_BREWMASTER2, -- Brewmast Monk Artifact Weapon
		[-9967] = ARTIFACT_MONK_WW, 							-- Windwalker Monk Artifact Weapon
		[-9968] = ARTIFACT_MONK_MISTWEAVER_WEAPONNAME, 			-- Mistweaver Monk Artifact Weapon
		[-9969] = ARTIFACT_DEMONHUNTER_VENGEANCE_WEAPONNAME, 	-- Vengeance Demon Hunter Artifact Weapon
		[-9970] = ARTIFACT_DEMONHUNTER_HAVOC_WEAPONNAME, 		-- Havoc Demon Hunter Artifact Weapon
		[-9971] = ARTIFACT_HUNTER_BEAST_WEAPONNAME, 			-- Beast Master Hunter Artifact Weapon
		[-9972] = ARTIFACT_HUNTER_MARKS_WEAPONNAME, 			-- Marksmanship Hunter Artifact Weapon
		[-9973] = ARTIFACT_HUNTER_SURV_WEAPONNAME, 				-- Survival Hunter Artifact Weapon
		[-9974] = ARTIFACT_SHAMAN_ELEMENTAL_WEAPONNAME, 		-- Elemental Shaman Artifact Weapon
		[-9975] = ARTIFACT_SHAMAN_ENHANCEMENT_WEAPONNAME, 		-- Enhancement Shaman Artifact Weapon
		[-9976] = ARTIFACT_SHAMAN_RESTORATION_WEAPONNAME, 		-- Restoration Shaman Artifact Weapon
		[-9977] = ARTIFACT_PALADIN_HOLY_WEAPONNAME, 			-- Holy Paladin Artifact Weapon
		[-9978] = ARTIFACT_PALADIN_PROT_WEAPONNAME, 			-- Protection Paladin Artifact Weapon
		[-9979] = ARTIFACT_PALADIN_RET_WEAPONNAME, 				-- Retribution Paladin Artifact Weapon
		[-9980] = ARTIFACT_WARRIOR_ARMS_WEAPONNAME, 			-- Arms Warrior Artifact Weapon
		[-9981] = ARTIFACT_WARRIOR_FURY_WEAPONNAME, 			-- Fury Warrior Artifact Weapon
		[-9982] = ARTIFACT_WARRIOR_PROT_WEAPONNAME.." "..ARTIFACT_WARRIOR_PROT_WEAPONNAME_SECOND, -- Protection Warrior Artifact Weapon
		[-9983] = ARTIFACT_DK_BLOOD, 							-- Blood Death Knight Artifact Weapon
		[-9984] = ARTIFACT_DK_FROST, 							-- Frost Death Knight Artifact Weapon
		[-9985] = ARTIFACT_DK_UNHOLY,		 					-- Unholy Death Knight Artifact Weapon		
-- Tier/Dungeon/Event/Holiday Sets 
	--Class Sets
		[-5352] = GARRISON_TIER.." "..WARDROBE_SETS,			-- Tier Sets
		[-5351] = "Class Hall Order Item Sets",
...
--]]
	...
	-- Holiday Sets
		...
		[-3159] = string.format(GARRISON_CURRENT_LEVEL.." "..WARDROBE_SETS, 21),
	-- PvP Sets
		[-4192] = ELITE, -- Elite
		[-4191] = "Gladiator",
		[-4190] = "Combatant",
	...
	["UNOBTAINABLE_ITEM_REASONS"] = {
		...
		{4, "|CFFFF0000Quests in Legacy are no longer available in game. This section is solely for you to be able to see what was obtained on your account.|r", "Quests"}, -- 12 -- Used for Legacy Quest Headers ONLY
		{4, "|CFFFF0000Due to the Cataclysm or other changes in mob level this mob no longer drops this item. Please inform us if you recieve an item listed here as a drop.|r", "Drop"}, -- 13 -- Used for Legacy Drop Headers ONLY
