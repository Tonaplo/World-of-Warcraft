...
function DailyToDo:HandleChatMessageCommands(msg)
   ...
   elseif command == "help" then
      self:Print("\"/dcl show\" : shows checklist")
      self:Print("\"/dcl hide\" : hides checklist")
      self:Print("\"/dcl show icon\" : shows minimap icon (requires ui restart to take effect)")
      self:Print("\"/dcl hide icon\" : hides minimap icon (requires ui restart to take effect)")
      self:Print("\"/dcl lock\" : locks checklist position")
      self:Print("\"/dcl unlock\" : unlocks checklist position")
      self:Print("\"/dcl check time\" : check if entries should be reset")
      self:Print("\"/dcl show completed\" : show completed entries")
      self:Print("\"/dcl hide completed\" : hide completed entries")
      self:Print("\"/dcl options\" : opens options dialog")
      self:Print("\"/dcl profiles\" : opens profiles dialog")
      self:Print("\"/dcl manager\" : opens manager dialog")
   else
      self:Print("Usage: \"/dcl <command> <identifier>\"")
      self:Print("Type: \"/dcl help\" for a list of commands")
   end
end
...
function DailyToDo:OnEnable()
   ...
   -- Notify user that DailyToDo is enabled, give config command
