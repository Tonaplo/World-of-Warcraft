...
statPriorityStats["MAGEFrost"] = "Critical Strike to 33.34% > Haste > Versatility > Mastery > Intellect"
...
statPriorityStats["WARLOCKDestruction"] = "Mastery > Haste > Critical Strike > Intellect > Versatility"
