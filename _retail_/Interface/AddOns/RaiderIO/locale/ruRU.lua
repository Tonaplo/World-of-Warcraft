...
L["USE_ENGLISH_ABBREVIATION"] = "Принудительное сокращение английского языка для подземелий"
L["USE_ENGLISH_ABBREVIATION_DESC"] = "Если установлено, это переопределяет аббревиатуры, используемые для подземелий, на английской версии, а не вашим текущим языком."
